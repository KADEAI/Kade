...
describe("McpToolRow", () => {
  ...
  it("hides parameters section when tool is disabled", () => {
    ...
    render(
      <McpToolRow tool={disabledToolWithSchema} serverName="test-server" />,
    );
  ...
  it("shows parameters section when tool is enabled", () => {
    ...
    render(
      <McpToolRow tool={enabledToolWithSchema} serverName="test-server" />,
    );
  ...
  it("shows normal styling for tool name and description when tool is enabled", () => {
    ...
    expect(toolName).not.toHaveClass(
      "text-vscode-descriptionForeground",
      "opacity-60",
    );
