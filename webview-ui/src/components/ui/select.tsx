  ...
  return (
    <SelectPrimitive.Portal container={container}>
      <SelectPrimitive.Content
        ...
        className={cn(
          "data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2 relative z-50 max-h-72 min-w-[8rem] overflow-hidden rounded-xl shadow-xl", // kade_change: increased radius and shadow
          "bg-popover",
          "border border-vscode-dropdown-border", // kade_change: use dropdown border instead of focus border
...
function SelectSeparator({
  ...
  return (
    <SelectPrimitive.Separator
      ...
      className={cn(
        "bg-vscode-dropdown-foreground/10 pointer-events-none -mx-1 my-1 h-px",
        className,
      )}
      {...props}
    />
