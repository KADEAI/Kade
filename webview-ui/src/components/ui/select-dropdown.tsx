		...
		(
			...
			const triggerContent = (
				<PopoverTrigger
					...
					className={cn(
						"w-auto min-w-0 inline-flex items-center gap-1.5 relative whitespace-nowrap px-1.5 py-1 text-xs",
			...
			return (
				<Popover open={open} onOpenChange={onOpenChange} data-testid="dropdown-root">
					...
					<PopoverContent
						...
						className={cn(
							"p-0 overflow-hidden bg-popover/40 backdrop-blur-2xl rounded-2xl w-auto max-w-[600px] border border-vscode-dropdown-border",
							contentClassName,
						)}>
						<div className="flex flex-col w-full overflow-hidden">
							...
							{!disableSearch && (
								<div className="relative p-2">
									<input
										...
										className="w-full h-8 px-2 py-1 text-xs bg-vscode-input-background text-vscode-input-foreground rounded focus:outline-0"
									/>
							...
							<div className={cn(
								...
								"w-full", // Use full width of container instead of fixed min-width
