...
>(({ className, ...props }, ref) => (
	<CommandPrimitive
		ref={ref}
		className={cn(
			"flex h-full w-full flex-col overflow-hidden rounded-xl bg-popover text-popover-foreground", // kade_change: rounded-xl
			className,
		)}
		{...props}
	/>
...
>(({ className, ...props }, ref) => (
	<CommandPrimitive.Item
		...
		className={cn(
			...
			"rounded-sm active:opacity-90 cursor-pointer", // kade_change: rounded-sm
			className,
		)}
		{...props}
	/>
