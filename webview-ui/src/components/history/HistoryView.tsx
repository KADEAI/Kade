          ...
          <div className="relative flex items-center gap-2 p-1 pb-2 border-b border-white/5 mb-2">
            ...
            >
              <SelectTrigger className="w-[100px] h-7 text-xs bg-transparent border-none hover:bg-vscode-toolbar-hoverBackground px-2 rounded-sm gap-1 justify-start">
                ...
                <span className="truncate">
                  {t(
                    `history:workspace.${showAllWorkspaces ? "all" : "current"}`,
                  )}
                </span>
              </SelectTrigger>
              <SelectContent>
            ...
            >
              ...
              <SelectContent align="end">
                ...
                <SelectItem value="mostExpensive" className="text-xs">
                  {t("history:mostExpensive")}
                </SelectItem>
                <SelectItem value="mostTokens" className="text-xs">
            ...
            <StandardTooltip content={t("history:favorites")}>
              ...
              >
                <span
                  className={`codicon ${showFavoritesOnly ? "codicon-star-full" : "codicon-star-empty"}`}
                />
              </Button>
            </StandardTooltip>
          ...
          <div className="p-2 flex justify-between items-center bg-vscode-input-background/20">
            ...
            <div className="flex gap-2">
              ...
              <Button
                variant="primary"
                size="sm"
                className="h-6 text-xs bg-red-500 hover:bg-red-600 text-white border-none"
