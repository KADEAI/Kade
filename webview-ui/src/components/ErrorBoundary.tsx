...
class ErrorBoundary extends Component<ErrorProps, ErrorState> {
  ...
  async componentDidCatch(error: Error, errorInfo: React.ErrorInfo) {
    ...
    const enhancedError = await enhanceErrorWithSourceMaps(
      error,
      componentStack,
    );
    ...
    telemetryClient.capture("error_boundary_caught_error", {
      ...
      componentStack:
        enhancedError.sourceMappedComponentStack || componentStack,
      timestamp: Date.now(),
    ...
    return (
      <div>
        ...
        <div className="mb-4">
          ...
          <pre className="p-2 border rounded text-sm overflow-auto">
            {errorDisplay}
          </pre>
        </div>
