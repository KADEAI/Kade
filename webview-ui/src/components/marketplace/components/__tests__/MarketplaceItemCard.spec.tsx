  ...
  useAppTranslation: () => ({
    t: (key: string, params?: any) => {
      ...
      const translations: Record<string, any> = {
        ...
        "marketplace:items.card.removeProjectTooltip":
          "Remove from current project",
        "marketplace:items.card.removeGlobalTooltip":
          "Remove from global configuration",
        "marketplace:items.card.noWorkspaceTooltip":
          "Open a workspace to install marketplace items",
        "marketplace:items.matched": "matched",
      };
      // Special handling for "marketplace:items.components" when it's used as a badge with count
      if (
        key === "marketplace:items.components" &&
...
describe("MarketplaceItemCard", () => {
  ...
  it("renders tags and handles tag clicks", async () => {
    ...
    renderWithProviders(
      <MarketplaceItemCard {...defaultProps} setFilters={setFilters} />,
    );
  ...
  it("does not render invalid author URLs", () => {
    ...
    renderWithProviders(
      <MarketplaceItemCard {...defaultProps} item={itemWithInvalidUrl} />,
    );
