...
describe("MarketplaceInstallModal - Nested Parameters", () => {
  ...
  it("should display effective parameters for selected installation method", () => {
    ...
    expect(
      screen.getByPlaceholderText("Enter package name"),
    ).toBeInTheDocument(); // Method-specific
    expect(
      screen.getByPlaceholderText("Enter NPM API key"),
    ).toBeInTheDocument(); // Overridden global
  ...
  it("should update parameters when switching installation methods", async () => {
    ...
    await waitFor(() => {
      expect(
        screen.getByPlaceholderText("Enter image name"),
      ).toBeInTheDocument();
      ...
      expect(
        screen.getByPlaceholderText("Optional setting"),
      ).toBeInTheDocument();
    });

    // Package name parameter should no longer be visible
    expect(
      screen.queryByPlaceholderText("Enter package name"),
    ).not.toBeInTheDocument();
    expect(
      screen.queryByPlaceholderText("Enter NPM API key"),
    ).not.toBeInTheDocument();
  });
  ...
  it("should validate required parameters from effective parameters", async () => {
    ...
    await waitFor(() => {
      expect(
        screen.getByText(/Please provide a value for/),
      ).toBeInTheDocument();
    });
