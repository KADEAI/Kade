...
import {
  ...
  VSCodeTextFieldWithNodesProps,
} from "./DecoratedVSCodeTextField";
...
interface FormattedTextFieldProps<T>
  extends Omit<VSCodeTextFieldWithNodesProps, "value" | "onInput"> {
  value: T | undefined;
...
export const FormattedTextField = forwardRef(
  FormattedTextFieldInner as any,
) as <T>(
