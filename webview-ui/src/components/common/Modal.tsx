...
export function Modal({
	...
	return ReactDOM.createPortal(
		<div
			className={`fixed inset-0 ${showBlur ? "bg-black/30 backdrop-blur-[60px]" : "bg-black/80"
			...
			onClick={onClose}>
			<div
				className={`flex flex-col relative animate-in zoom-in-95 duration-200 ${className ||
