    ...
    <div className="flex items-center gap-2">
      <StandardTooltip content={zoomOutTitle}>
        <IconButton
          ...
          onClick={
            !useContinuousZoom
              ? onZoomOut || (() => adjustZoom?.(zoomOutStep))
              : undefined
          }
          onMouseDown={
            useContinuousZoom && adjustZoom
              ? () => startContinuousZoom(zoomOutStep)
              : undefined
          }
          onMouseUp={
            useContinuousZoom && adjustZoom ? stopContinuousZoom : undefined
          }
          onMouseLeave={
            useContinuousZoom && adjustZoom ? stopContinuousZoom : undefined
          }
      ...
      <StandardTooltip content={zoomInTitle}>
        <IconButton
          ...
          onClick={
            !useContinuousZoom
              ? onZoomIn || (() => adjustZoom?.(zoomInStep))
              : undefined
          }
          onMouseDown={
            useContinuousZoom && adjustZoom
              ? () => startContinuousZoom(zoomInStep)
              : undefined
          }
          onMouseUp={
            useContinuousZoom && adjustZoom ? stopContinuousZoom : undefined
