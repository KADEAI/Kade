...
describe("ImageViewer", () => {
  it("should render image with webview URI", () => {
    ...
    const { container } = render(
      <ImageViewer imageUri={webviewUri} alt="Test image" />,
    );
  ...
  it("should render image with vscode-resource URI", () => {
    ...
    const { container } = render(
      <ImageViewer imageUri={vscodeResourceUri} alt="Test image" />,
    );
  ...
  it("should handle base64 images", () => {
    ...
    const { container } = render(
      <ImageViewer imageUri={base64Image} alt="Base64 image" />,
    );
  ...
  it("should handle error state gracefully", () => {
    ...
    const { container } = render(
      <ImageViewer imageUri={invalidUri} alt="Invalid image" />,
    );
