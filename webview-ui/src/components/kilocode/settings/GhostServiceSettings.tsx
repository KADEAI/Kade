...
type GhostServiceSettingsViewProps = HTMLAttributes<HTMLDivElement> & {
  ...
  onGhostServiceSettingsChange: <
    K extends keyof NonNullable<GhostServiceSettings>,
  >(
    field: K,
...
export const GhostServiceSettingsView = ({
  ...
  const keybindings = useKeybindings([
    "kilo-code.addToContextAndFocus",
          ...
          <div className="flex flex-col gap-4">
            <div className="flex flex-col gap-1.5">
              <div className="flex items-center justify-between">
                <VSCodeCheckbox
                  checked={enableAutoTrigger || false}
                  onChange={onEnableAutoTriggerChange}
                >
                ...
                <StandardTooltip
                  content={t(
                    "kilocode:ghost.settings.enableAutoTrigger.description",
                  )}
                >
                  ...
                  {isSnoozed ? (
                    ...
                    <div className="flex items-center gap-2">
                      <Select
                        ...
                        onValueChange={(value) =>
                          setSnoozeDuration(Number(value))
                        }
                      >
                        ...
                        <SelectContent>
                          {EXTREME_SNOOZE_VALUES_ENABLED && (
                            <SelectItem value="60">
                              {t(
                                "kilocode:ghost.settings.snooze.duration.1min",
                              )}
                            </SelectItem>
                          )}
                    ...
                    >
                      <span className="font-medium text-sm">
                        {t(
                          ...
                          {
                            keybinding:
                              keybindings["kilo-code.addToContextAndFocus"],
                          },
                        )}
                      </span>
                    </VSCodeCheckbox>
            ...
            <div className="flex flex-col gap-1.5 border-t border-vscode-input-border/10 pt-3">
              <div className="flex items-center justify-between">
                ...
                <StandardTooltip
                  content={t(
                    "kilocode:ghost.settings.enableChatAutocomplete.description",
                  )}
                >
                  <Info className="size-3.4 text-vscode-descriptionForeground cursor-help" />
                </StandardTooltip>
