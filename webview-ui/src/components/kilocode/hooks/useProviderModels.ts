  ...
  switch (provider) {
    ...
    case "antigravity": {
      return {
        ...
        defaultModel: antigravityDefaultModelId,
      };
    }
    case "zed": {
      return {
        models: routerModels.zed,
        defaultModel: zedDefaultModelId,
      };
    }
    case "gemini-cli": {
      return {
    ...
    case "opencode": {
      return {
        ...
        defaultModel: opencodeDefaultModelId,
      };
    }
    case "bluesminds": {
      return {
        models: routerModels.bluesminds,
        defaultModel: bluesmindsDefaultModelId,
      };
    }
    //kade_change end
    case "minimax": {
...
export const getOptionsForProvider = (
  provider: ProviderName,
    ...
    case "zai":
      ...
      return {
        isChina:
          ...
          apiConfiguration?.zaiApiLine === "china_api",
      };
    // kade_change end
    default:
      return {};
...
export const useProviderModels = (apiConfiguration?: ProviderSettings) => {
  ...
  const routerModels = useRouterModels({
    ...
    zedAuthenticated: apiConfiguration?.apiProvider === "zed" ? true : undefined,
  });
