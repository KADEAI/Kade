...
const RulesWorkflowsSection: React.FC<RulesWorkflowsSectionProps> = ({
  ...
  const globalSectionKey =
    type === "rule"
      ? "kilocode:rules.sections.globalRules"
      : "kilocode:rules.sections.globalWorkflows";
  const workspaceSectionKey =
    type === "rule"
      ? "kilocode:rules.sections.workspaceRules"
      : "kilocode:rules.sections.workspaceWorkflows";
