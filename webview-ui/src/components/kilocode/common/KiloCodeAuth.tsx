...
const KiloCodeAuth: React.FC<KiloCodeAuthProps> = ({ className = "", welcomeMode = false }) => {
	...
	if (welcomeMode) {
		return (
			<div className={`relative min-h-screen min-w-full overflow-hidden ${className}`}>
							...
							<div className="mb-10 flex items-center gap-4">
								...
								<div className="space-y-1">
									...
									<p className="m-0 max-w-xs text-sm leading-6 text-vscode-descriptionForeground">
										An IDE-native coding partner with a calmer, more intentional workspace.
									</p>
								</div>
							</div>
							...
							<div className="mt-10 grid gap-3 sm:grid-cols-3">
								<div className="rounded-2xl border border-white/10 bg-white/5 p-4">
									...
									<p className="mt-2 mb-0 text-sm leading-6 text-vscode-foreground">
										Stay in motion with fewer modal detours and clearer next steps.
									</p>
								</div>
								<div className="rounded-2xl border border-white/10 bg-white/5 p-4">
									<p className="m-0 text-[10px] uppercase tracking-[0.28em] text-vscode-descriptionForeground">
								...
								<div className="rounded-2xl border border-white/10 bg-white/5 p-4">
									...
									<p className="mt-2 mb-0 text-sm leading-6 text-vscode-foreground">
										Bring your own workflow and move at the pace that feels right.
									</p>
								</div>
							</div>
						</section>
						...
						<aside className="flex flex-col justify-between rounded-[28px] border border-white/10 bg-[color:color-mix(in_srgb,var(--vscode-sideBar-background)_88%,black_12%)] p-6 shadow-[0_24px_80px_rgba(0,0,0,0.28)] backdrop-blur-xl sm:p-8">
							<div>
								...
								<p className="mt-4 mb-0 text-sm leading-7 text-vscode-descriptionForeground">
									The welcome flow is intentionally lightweight. One tap takes you into the
									main interface, and you can fine-tune the rest once you are inside.
								</p>
							</div>
							...
							<div className="mt-8 space-y-4">
								<div className="rounded-2xl border border-white/10 bg-black/15 p-4">
									...
									<p className="mt-2 mb-0 text-sm leading-6 text-vscode-foreground">
										Open chat, explore the interface, and shape the setup from inside the app.
									</p>
								</div>

								<ButtonPrimary onClick={handleContinue}>{t("kilocode:welcome.ctaButton")}</ButtonPrimary>
							</div>
						</aside>
					</div>
				</div>
	...
	return (
		<div className={`flex flex-col items-center relative min-h-screen min-w-full ${className}`}>
