...
export const OrganizationSelector = ({
  ...
  const selectedOrg = organizations.find(
    (o) => o.id === apiConfiguration?.kilocodeOrganizationId,
  );
  ...
  const handleMessage = (event: MessageEvent<WebviewMessage>) => {
    ...
    if (message.type === "profileDataResponse") {
      ...
      if (payload.success) {
        ...
        console.error(
          "Error fetching profile organizations data:",
          payload.error,
        );
        setOrganizations([]);
      }
  ...
  const setSelectedOrganization = (
    organization: UserOrganizationWithApiKey | null,
  ) => {
      ...
      <div className="relative" ref={containerRef}>
        ...
        >
          <span className="truncate">
            {selectedOrg ? selectedOrg.name : t("kilocode:profile.personal")}
          </span>
