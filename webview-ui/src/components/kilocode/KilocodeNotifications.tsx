		...
		<div className="kilocode-notifications flex flex-col mb-4 w-full">
			<div className="bg-vscode-editor-background/50 backdrop-blur-sm border border-vscode-panel-border rounded-xl p-4 gap-3 shadow-sm">
				<div className="flex items-center justify-between">
					<h3 className="font-semibold text-vscode-foreground m-0 tracking-tight">{currentNotification.title}</h3>
					<button
				...
				<p className="text-vscode-descriptionForeground text-sm leading-relaxed">{currentNotification.message}</p>
