	...
	return (
		<div className="flex flex-col gap-1">
			<div className="flex items-center justify-between">
				<VSCodeCheckbox checked={rateLimitAfterEnabled} onChange={handleRateLimitAfterChange}>
					<span className="font-medium text-sm">{t("settings:providers.rateLimitAfter.label")}</span>
				</VSCodeCheckbox>
				<StandardTooltip content={t("settings:providers.rateLimitAfter.description")}>
