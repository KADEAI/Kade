...
const SettingRow = ({
  ...
  <div className={cn("flex flex-col gap-1.5", className)}>
    <div className="flex items-center justify-between">
      <span className="text-[13px] font-medium text-vscode-foreground/90">
        {label}
      </span>
      {description && (
        <StandardTooltip content={description}>
...
export const ContextManagementSettings = ({
  ...
  const [selectedThresholdProfile, setSelectedThresholdProfile] =
  ...
  useRegisterSetting({
    settingId: "context-max-image-size",
    section: "contextManagement",
  ...
  useRegisterSetting({
    settingId: "context-allow-large-reads",
    section: "contextManagement",
    label: t("kilocode:settings.contextManagement.allowVeryLargeReads.label"),
  });
  useRegisterSetting({
    settingId: "context-include-time",
    section: "contextManagement",
    label: t("settings:contextManagement.includeCurrentTime.label"),
  });
  useRegisterSetting({
    settingId: "context-include-cost",
    section: "contextManagement",
    label: t("settings:contextManagement.includeCurrentCost.label"),
  });
  useRegisterSetting({
    settingId: "context-include-diagnostics",
    section: "contextManagement",
  ...
  const handleThresholdChange = (value: number) => {
    if (selectedThresholdProfile === "default") {
      ...
      vscode.postMessage({
        type: "updateSettings",
        updatedSettings: { profileThresholds: newThresholds },
      });
    }
  };
      ...
      <Section className="grid grid-cols-1 gap-6">
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex h-5 items-center">
                <VSCodeCheckbox
                  ...
                  onChange={(e: any) =>
                    setCachedStateField("autoCondenseContext", e.target.checked)
                  }
                  className="m-0"
            ...
            {autoCondenseContext && (
              <div className="flex flex-col gap-4 pl-4 border-l-2 border-vscode-focusBorder bg-vscode-focusBorder/5 p-4 rounded-xl animate-in fade-in slide-in-from-left-2 duration-300">
                ...
                <div className="flex flex-col gap-3">
                  ...
                  >
                    <SelectTrigger
                      className="w-full h-8 text-xs bg-vscode-input-background"
        ...
        <SettingsCard title="Workspace Resources" icon={Layers}>
            ...
            >
              <div className="flex items-center gap-4">
                <Slider
                  ...
                  onValueChange={([value]) =>
                    setCachedStateField("maxOpenTabsContext", value)
                  }
                  className="flex-1"
          ...
          <div data-setting-id="context-workspace-files">
            <SettingRow
              label={t("settings:contextManagement.workspaceFiles.label")}
              description={t(
                "settings:contextManagement.workspaceFiles.description",
              )}
            >
              <div className="flex items-center gap-4">
                <Slider
                  ...
                  onValueChange={([value]) =>
                    setCachedStateField("maxWorkspaceFiles", value)
                  }
                  className="flex-1"
          ...
          <div data-setting-id="context-git-status-files">
            <SettingRow
              label={t("settings:contextManagement.maxGitStatusFiles.label")}
              description={t(
                "settings:contextManagement.maxGitStatusFiles.description",
              )}
            >
              <div className="flex items-center gap-4">
                <Slider
                  ...
                  onValueChange={([value]) =>
                    setCachedStateField("maxGitStatusFiles", value)
                  }
                  className="flex-1"
          ...
          <div className="pt-2 border-t border-vscode-widget-border/50">
            ...
            >
              <div className="flex items-center gap-2">
                ...
                <StandardTooltip
                  content={t(
                    "settings:contextManagement.rooignore.description",
                  )}
                >
                  <Info className="w-3 h-3 text-vscode-descriptionForeground cursor-help" />
                </StandardTooltip>
        ...
        <SettingsCard title="File Reading Controls" icon={FileText}>
          <div data-setting-id="context-concurrent-reads">
            <SettingRow
              label={t(
                "settings:contextManagement.maxConcurrentFileReads.label",
              )}
              description={t(
                "settings:contextManagement.maxConcurrentFileReads.description",
              )}
            >
              <div className="flex items-center gap-4">
                <Slider
          ...
          <div data-setting-id="context-max-read-file">
            <SettingRow
              label={t("settings:contextManagement.maxReadFile.label")}
              description={t(
                "settings:contextManagement.maxReadFile.description",
              )}
            >
          ...
          <div className="grid grid-cols-2 gap-4">
            <div data-setting-id="context-max-image-size">
              <SettingRow
                label={t("settings:contextManagement.maxImageFileSize.label")}
                description={t(
                  "settings:contextManagement.maxImageFileSize.description",
                )}
              >
                <div className="flex items-center gap-2">
                  <Input
            ...
            <div data-setting-id="context-max-total-image-size">
              <SettingRow
                label={t("settings:contextManagement.maxTotalImageSize.label")}
                description={t(
                  "settings:contextManagement.maxTotalImageSize.description",
                )}
              >
                <div className="flex items-center gap-2">
                  <Input
          ...
          <div className="pt-2 border-t border-vscode-widget-border/50">
            <VSCodeCheckbox
              ...
              onChange={(e: any) =>
                setCachedStateField("allowVeryLargeReads", e.target.checked)
              }
              className="m-0"
            >
              <div className="flex items-center gap-2">
                <span className="text-[13px] font-medium">
                  {t(
                    "kilocode:settings.contextManagement.allowVeryLargeReads.label",
                  )}
                </span>
                <StandardTooltip
                  content={t(
                    "kilocode:settings.contextManagement.allowVeryLargeReads.description",
                  )}
                >
                  <Info className="w-3 h-3 text-vscode-descriptionForeground cursor-help" />
                </StandardTooltip>
          ...
          <div className="flex flex-col gap-4">
            <div className="flex flex-col gap-3">
              <div data-setting-id="context-include-time">
                <VSCodeCheckbox
                  ...
                  onChange={(e: any) =>
                    setCachedStateField("includeCurrentTime", e.target.checked)
                  }
                  className="m-0"
              ...
              <div data-setting-id="context-include-cost">
                <VSCodeCheckbox
                  ...
                  onChange={(e: any) =>
                    setCachedStateField("includeCurrentCost", e.target.checked)
                  }
                  className="m-0"
            ...
            {includeDiagnosticMessages && (
              <div className="mt-1 flex flex-col gap-5 pl-4 border-l-2 border-vscode-widget-border/20 p-4">
                ...
                >
                  <div className="flex items-center gap-4">
                    ...
                    <Button
                      ...
                      size="icon"
                      onClick={() =>
                        setCachedStateField("maxDiagnosticMessages", 50)
                      }
                ...
                <SettingRow
                  label={t(
                    "settings:contextManagement.diagnostics.delayAfterWrite.label",
                  )}
                  description={t(
                    "settings:contextManagement.diagnostics.delayAfterWrite.description",
                  )}
                >
                  <div className="flex items-center gap-4">
                    <Slider
