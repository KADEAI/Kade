...
export const UISettings = ({
	...
	useRegisterSetting({ settingId: "ui-collapse-thinking", section: "ui", label: t("settings:ui.collapseThinking.label") })
	useRegisterSetting({ settingId: "ui-require-ctrl-enter", section: "ui", label: t("settings:ui.requireCtrlEnterToSend.label", { primaryMod }) })
			...
			<Section className="flex flex-col gap-6">
				...
				<div className="rounded-[24px] border border-vscode-input-border/30 bg-vscode-editor-background/40 p-5 flex flex-col gap-5 shadow-xl">
					...
					<div className="flex flex-col gap-5">
						...
						<div className="flex flex-col gap-1.5" data-setting-id="ui-collapse-thinking">
							<VSCodeCheckbox
								checked={reasoningBlockCollapsed}
								onChange={(e: any) => handleReasoningBlockCollapsedChange(e.target.checked)}
								data-testid="collapse-thinking-checkbox">
								<span className="font-medium text-[13px]">{t("settings:ui.collapseThinking.label")}</span>
							</VSCodeCheckbox>
						...
						<div className="flex flex-col gap-1.5" data-setting-id="ui-require-ctrl-enter">
							<VSCodeCheckbox
