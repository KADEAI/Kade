...
import { X, CheckCheck, CheckCircle2, Settings, Shield, ListFilter, AlertTriangle, AlertOctagon, Terminal, AlertCircle, Info, Hash } from "lucide-react"
...
import { Button, Input, Slider, Select, SelectContent, SelectItem, SelectTrigger, SelectValue, StandardTooltip } from "@/components/ui"
...
export const AutoApproveSettings = ({
	...
	useRegisterSetting({ settingId: "auto-approve-show-menu", section: "autoApprove", label: t("settings:autoApprove.showMenu.label") })
	useRegisterSetting({ settingId: "auto-approve-enabled", section: "autoApprove", label: t("settings:autoApprove.enabled") })
	useRegisterSetting({ settingId: "auto-approve-read-only", section: "autoApprove", label: t("settings:autoApprove.readOnly.label") })
	useRegisterSetting({ settingId: "auto-approve-write", section: "autoApprove", label: t("settings:autoApprove.write.label") })
	useRegisterSetting({ settingId: "auto-approve-browser", section: "autoApprove", label: t("settings:autoApprove.browser.label") })
	useRegisterSetting({ settingId: "auto-approve-retry", section: "autoApprove", label: t("settings:autoApprove.retry.label") })
	useRegisterSetting({ settingId: "auto-approve-mcp", section: "autoApprove", label: t("settings:autoApprove.mcp.label") })
	useRegisterSetting({ settingId: "auto-approve-mode", section: "autoApprove", label: t("settings:autoApprove.modeSwitch.label") })
	useRegisterSetting({ settingId: "auto-approve-subtasks", section: "autoApprove", label: t("settings:autoApprove.subtasks.label") })
	useRegisterSetting({ settingId: "auto-approve-execute", section: "autoApprove", label: t("settings:autoApprove.execute.label") })
	useRegisterSetting({ settingId: "auto-approve-followup", section: "autoApprove", label: t("settings:autoApprove.followupQuestions.label") })
	useRegisterSetting({ settingId: "auto-approve-todo", section: "autoApprove", label: t("settings:autoApprove.updateTodoList.label") })
	useRegisterSetting({ settingId: "auto-approve-max-requests", section: "autoApprove", label: t("settings:autoApprove.apiRequestLimit.title") })
	useRegisterSetting({ settingId: "auto-approve-max-cost", section: "autoApprove", label: t("settings:autoApprove.apiCostLimit.title") })
			...
			<Section className="flex flex-col gap-6">
				...
				<div className="rounded-[24px] border border-vscode-input-border/30 bg-vscode-editor-background/40 p-5 flex flex-col gap-5 shadow-xl">
					...
					<div className="flex flex-col gap-3">
						<div className="flex items-center gap-2" data-setting-id="auto-approve-show-menu">
							<VSCodeCheckbox
								...
								<span className="font-medium text-[13px]">{t("settings:autoApprove.showMenu.label")}</span>
							</VSCodeCheckbox>
							<StandardTooltip content={t("settings:autoApprove.showMenu.description")}>
								<Info className="size-3 text-vscode-descriptionForeground cursor-help" />
							</StandardTooltip>
						</div>

						<div className="flex flex-col gap-2">
							<div className="flex items-center gap-2" data-setting-id="auto-approve-enabled">
								<VSCodeCheckbox
									...
									<span className="font-medium text-[13px]">{t("settings:autoApprove.enabled")}</span>
								</VSCodeCheckbox>
								<StandardTooltip content={t("settings:autoApprove.description")}>
									<Info className="size-3 text-vscode-descriptionForeground cursor-help" />
								</StandardTooltip>
							</div>
				...
				{(alwaysAllowReadOnly || alwaysAllowWrite || alwaysApproveResubmit || alwaysAllowFollowupQuestions) && (
					<div className="rounded-[24px] border border-vscode-input-border/30 bg-vscode-editor-background/40 p-5 flex flex-col gap-5 shadow-xl">
						<div className="flex items-center gap-2 border-b border-vscode-input-border/50 pb-2">
							<Settings className="size-3.5 text-vscode-foreground" />
							<span className="text-[11px] font-bold uppercase tracking-widest text-vscode-foreground/80">
							...
							{alwaysAllowReadOnly && (
								<div className="flex flex-col gap-2 pl-3 border-l-2 border-vscode-focusBorder/50">
									...
									<div className="flex gap-2 items-center">
										...
										<StandardTooltip content={t("settings:autoApprove.readOnly.outsideWorkspace.description")}>
											<Info className="size-3 text-vscode-descriptionForeground cursor-help" />
										</StandardTooltip>
									</div>
								</div>
								...
								<div className="flex flex-col gap-2 pl-3 border-l-2 border-vscode-focusBorder/50">
									...
									<div className="flex flex-col gap-2">
										<div className="flex gap-2 items-center">
											...
											<StandardTooltip content={t("settings:autoApprove.write.outsideWorkspace.description")}>
												<Info className="size-3 text-vscode-descriptionForeground cursor-help" />
											</StandardTooltip>
										</div>
										<div className="flex gap-2 items-center">
											<VSCodeCheckbox
												...
												<span className="font-medium text-[13px]">{t("settings:autoApprove.write.protected.label")}</span>
											</VSCodeCheckbox>
											<StandardTooltip content={t("settings:autoApprove.write.protected.description")}>
												<Info className="size-3 text-vscode-descriptionForeground cursor-help" />
											</StandardTooltip>
										</div>
									</div>
									...
									<div className="flex flex-col gap-1">
										<div className="flex items-center gap-3">
											<Slider
												...
												className="flex-1"
											/>
											<span className="w-12 text-center text-xs font-mono bg-vscode-input-background rounded border border-vscode-input-border px-1 py-0.5">{requestDelaySeconds}s</span>
										</div>
									...
									<div className="flex flex-col gap-1">
										<div className="flex items-center gap-3">
											<Slider
												...
												className="flex-1"
											/>
											<span className="w-12 text-center text-xs font-mono bg-vscode-input-background rounded border border-vscode-input-border px-1 py-0.5">{followupAutoApproveTimeoutMs / 1000}s</span>
										</div>
										<div className="text-vscode-descriptionForeground text-[11px] leading-relaxed opacity-90">
						...
						<div className="flex flex-col gap-4">
							<div className="flex flex-col gap-2">
								<div className="flex items-center justify-between">
									<label className="text-[13px] font-medium" data-testid="allowed-commands-heading">
										{t("settings:autoApprove.execute.allowedCommands")}
									</label>
									<StandardTooltip content={t("settings:autoApprove.execute.allowedCommandsDescription")}>
								...
								<div className="flex gap-2">
									...
									/>
									<Button className="h-8 px-3 text-xs" onClick={handleAddCommand} data-testid="add-command-button">
							...
							<div className="flex flex-col gap-2">
								<div className="flex items-center justify-between">
									<label className="text-[13px] font-medium" data-testid="denied-commands-heading">
										{t("settings:autoApprove.execute.deniedCommands")}
									</label>
									<StandardTooltip content={t("settings:autoApprove.execute.deniedCommandsDescription")}>
										<AlertCircle className="size-3.5 text-vscode-descriptionForeground cursor-help" />
									</StandardTooltip>
								</div>
								...
								<div className="flex gap-2">
									...
									/>
									<Button className="h-8 px-3 text-xs" onClick={handleAddDeniedCommand} data-testid="add-denied-command-button">
										{t("settings:autoApprove.execute.addButton")}
									</Button>
								</div>
