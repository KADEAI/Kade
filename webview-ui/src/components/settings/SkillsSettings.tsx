...
export const SkillsSettings = ({
  ...
  const [localEnabledSkills, setLocalEnabledSkills] =
    useState<string[]>(enabledSkills);
        ...
        <div className="flex flex-col gap-3">
          <div className="flex items-center gap-2">
            <span className="text-sm text-vscode-descriptionForeground">
              Enable the skills you want the agent to know are available.
              Enabled skills are exposed as an on-demand registry, and the agent
              can open each skill's <code>SKILL.md</code> only when it is
              relevant.
            </span>
          ...
          {isLoading ? (
            ...
            <div className="bg-vscode-inputValidation-infoBackground border border-vscode-inputValidation-infoBorder rounded-lg p-4">
              <p className="text-sm text-vscode-descriptionForeground">
                No skills installed yet. Visit the Skills tab in the Marketplace
