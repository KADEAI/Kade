...
export const FastApplySettings = ({
	...
	useRegisterSetting({ settingId: "fast-apply-provider", section: "experimental", label: t("settings:experimental.MORPH_FAST_APPLY.apiProvider") })
	useRegisterSetting({ settingId: "fast-apply-model", section: "experimental", label: t("settings:experimental.MORPH_FAST_APPLY.modelLabel") })
	useRegisterSetting({ settingId: "fast-apply-key", section: "experimental", label: t("settings:experimental.MORPH_FAST_APPLY.apiKey") })
	return (
		<div className="flex flex-col gap-5">
			<div data-setting-id="fast-apply-provider">
				...
				<Select
					...
					onValueChange={(value) => setCachedStateField("fastApplyApiProvider", value)}>
			...
			<div data-setting-id="fast-apply-model">
				...
				<Select
					...
					onValueChange={(value) => setCachedStateField("fastApplyModel", value)}>
					<SelectTrigger className="w-full">
						<SelectValue placeholder="Select model" />
					</SelectTrigger>
					<SelectContent>
						<SelectItem value="auto">{t("settings:experimental.MORPH_FAST_APPLY.models.auto")}</SelectItem>
