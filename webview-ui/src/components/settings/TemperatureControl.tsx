		...
		<div className="flex flex-col gap-1">
			<div className="flex items-center justify-between">
				<VSCodeCheckbox
					...
					<span className="font-medium text-sm">{t("settings:temperature.useCustom")}</span>
				</VSCodeCheckbox>
				...
				<div className="flex flex-col gap-3 pl-3 border-l-2 border-vscode-button-background">
					<div>
						<div className="flex items-center justify-between mb-2">
							...
							<StandardTooltip content={t("settings:temperature.rangeDescription")}>
						...
						<div className="flex items-center gap-2">
							<Slider
								...
								className="flex-1"
							/>
							<span className="text-[10px] font-mono min-w-[30px]">{inputValue}</span>
						</div>
					</div>
				</div>
			)}
