    ...
    <div className="space-y-4">
      <div className="flex flex-col gap-1.5">
        ...
        <p className="text-vscode-descriptionForeground text-[11px] leading-relaxed opacity-90 pl-7">
          Enable voice input for chat. Can use cloud APIs (OpenAI/Gemini) or a
          local Whisper model running on your browser via WebGPU.
        </p>
      </div>
      ...
      {enabled && (
        <div className="flex flex-col gap-5 pl-4 border-l-2 border-vscode-focusBorder/50 ml-1">
          ...
          <div data-setting-id="stt-provider">
            ...
            <Select
              value={sttProvider}
              onValueChange={(value) => setSttProvider(value as any)}
            >
              ...
              <SelectContent>
                ...
                <SelectItem value="local">
                  Local Whisper (WebGPU - Privacy First)
                </SelectItem>
              </SelectContent>
            </Select>
          ...
          {sttProvider === "local" && (
            <div data-setting-id="stt-model">
              ...
              <p className="text-vscode-descriptionForeground text-[11px] mt-2 opacity-80 leading-relaxed">
                Smaller models are faster but less accurate. Tiny/Base are
