...
export const SubAgentSettings = ({
  ...
  const {
    apiConfiguration: mainApiConfiguration,
    ...
    <div className="flex flex-col gap-6">
      <Section title={t("kilocode:settings.subAgents.title")}>
        <div className="flex flex-col gap-4">
          {!isUnlocked && (
            <div className="bg-vscode-inputValidation-infoBackground border border-vscode-inputValidation-infoBorder rounded-lg p-4 flex flex-col gap-3">
              ...
              <p className="text-sm text-vscode-descriptionForeground">
                Unlock the most powerful sub-agent feature ever made for an
                agentic IDE. Get your Pro License for just $5 to enable advanced
              ...
              <div className="flex flex-col gap-2 mt-1">
                ...
                <div className="flex items-center gap-2 mt-2">
                  <VSCodeTextField
                    ...
                    value={proLicenseKey || ""}
                    onInput={(e: any) =>
                      setCachedStateField("proLicenseKey", e.target.value)
                    }
                    className="flex-1"
                  />
                </div>
          ...
          <div
            className={`flex flex-col gap-4 ${!isUnlocked ? "opacity-50 pointer-events-none" : ""}`}
          >
            <div
                ...
                {isSubAgentOpsInstalled ? (
                  ...
                  <>
                    <span className="text-sm font-medium text-white/90">
                      Install Sub Agent Ops Mode
                    </span>
                    <span className="text-xs text-vscode-descriptionForeground">
                      Install the Sub Agent Ops mode for a more refined
                      sub-agent experience with better delegation and
                      orchestration flows.
                    </span>
                  </>
                )}
            ...
            <div className="flex items-center gap-2">
              <VSCodeCheckbox
                ...
                onChange={(e: any) =>
                  setCachedStateField("subAgentToolEnabled", e.target.checked)
                }
              >
                <span className="font-medium text-sm">
                  {t("kilocode:subAgents.enableTool.label")}
                </span>
              </VSCodeCheckbox>
              <StandardTooltip
                content={t("kilocode:subAgents.enableTool.description")}
              >
            ...
            <div className="bg-white/[0.02] border border-white/[0.05] rounded-lg p-4 flex flex-col gap-4">
              <div className="flex flex-col gap-1">
                ...
                >
                  Note: To use, simply tell your main agent to spawn sub agents
                  to do (x) task.
                </span>
              </div>
              ...
              <ApiOptions
                ...
                setApiConfigurationField={(field, value, isUserAction) =>
                  handleApiFieldChange(field, value, isUserAction)
                }
