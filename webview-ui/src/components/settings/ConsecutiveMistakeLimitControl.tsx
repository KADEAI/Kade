...
export const ConsecutiveMistakeLimitControl = ({
  value,
  onChange,
}: ConsecutiveMistakeLimitControlProps) => {
    ...
    <div className="flex flex-col gap-1">
      <div className="flex items-center justify-between mb-2">
        <label className="block text-sm font-medium">
          {t("settings:providers.consecutiveMistakeLimit.label")}
        </label>
