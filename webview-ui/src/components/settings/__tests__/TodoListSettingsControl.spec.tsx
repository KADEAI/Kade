...
describe("TodoListSettingsControl", () => {
  it("renders with default props", () => {
    ...
    const description = screen.getByText(
      /When enabled, Roo can create and manage todo lists/,
    );
  ...
  it("renders with todoListEnabled set to false", () => {
    const onChange = vi.fn();
    render(
      <TodoListSettingsControl todoListEnabled={false} onChange={onChange} />,
    );
  ...
  it("calls onChange when checkbox is clicked", () => {
    const onChange = vi.fn();
    render(
      <TodoListSettingsControl todoListEnabled={true} onChange={onChange} />,
    );
