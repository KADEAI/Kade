...
// kade_change: our about screen is very different
describe.skip("About", () => {
  const defaultProps = {
  ...
  it("renders the bug report section with label and link text", () => {
    ...
    expect(
      screen.getByText("settings:about.bugReport.label"),
    ).toBeInTheDocument();
    expect(
      screen.getByText("settings:about.bugReport.link"),
    ).toBeInTheDocument();
  });
  ...
  it("renders the feature request section with label and link text", () => {
    ...
    expect(
      screen.getByText("settings:about.featureRequest.label"),
    ).toBeInTheDocument();
    expect(
      screen.getByText("settings:about.featureRequest.link"),
    ).toBeInTheDocument();
  });
  ...
  it("renders the security issue section with label and link text", () => {
    ...
    expect(
      screen.getByText("settings:about.securityIssue.label"),
    ).toBeInTheDocument();
    expect(
      screen.getByText("settings:about.securityIssue.link"),
    ).toBeInTheDocument();
  });
  ...
  it("renders the contact section with label and email", () => {
    ...
    expect(
      screen.getByText("settings:about.contact.label"),
    ).toBeInTheDocument();
  ...
  it("renders export, import, and reset buttons", () => {
    ...
    expect(
      screen.getByText("settings:footer.settings.export"),
    ).toBeInTheDocument();
    expect(
      screen.getByText("settings:footer.settings.import"),
    ).toBeInTheDocument();
    expect(
      screen.getByText("settings:footer.settings.reset"),
    ).toBeInTheDocument();
  });
});
