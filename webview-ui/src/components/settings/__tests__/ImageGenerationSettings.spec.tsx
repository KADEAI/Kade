...
// kade_change: other settings menu for now, to be made similar later
describe.skip("ImageGenerationSettings", () => {
  ...
  describe("User Interaction Behavior", () => {
    it("should call setimageGenerationSettings when user changes API key", async () => {
      ...
      expect(defaultProps.setOpenRouterImageApiKey).toHaveBeenCalledWith(
        "new-api-key",
      );
    });
  ...
  describe("Conditional Rendering", () => {
    ...
    it("should not render input fields when enabled is false", () => {
      const { queryByPlaceholderText } = render(
        <ImageGenerationSettings {...defaultProps} enabled={false} />,
      );
