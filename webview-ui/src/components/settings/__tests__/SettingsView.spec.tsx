...
vi.mock("@src/utils/validate", () => ({
  ...
  validateApiConfigurationExcludingModelErrors: vi
    .fn()
...
vi.mock("@/components/ui", () => ({
  ...
  Select: ({ children, value, onValueChange }: any) => (
    <div data-testid="select" data-value={value}>
      <button onClick={() => onValueChange && onValueChange("test-change")}>
        {value}
      </button>
      {children}
    </div>
...
describe("SettingsView - Allowed Commands", () => {
  ...
  describe("SettingsView - Tab Navigation", () => {
    ...
    it("shows unsaved changes dialog when clicking Done with unsaved changes", () => {
      ...
      expect(
        screen.getByText("settings:unsavedChangesDialog.title"),
      ).toBeInTheDocument();
    });
    ...
    it("renders with targetSection prop", () => {
      ...
      expect(
        screen.queryByTestId("api-config-management"),
