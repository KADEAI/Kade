...
// kade_change: no filtering done on providers client side
describe.skip("ApiOptions Provider Filtering", () => {
	...
	it("should hide static providers with empty models", () => {
		...
		PROVIDERS.push({ value: "emptyProvider", label: "Empty Provider", website: "https://example.com" })
	...
	it("should always show dynamic providers even if they have no models yet", () => {
		...
		expect(providerValues).toContain("glama") // kade_change
	...
	it("should always show currently selected provider even if it has no models", () => {
		...
		PROVIDERS.push({ value: "testEmptyProvider", label: "Test Empty Provider", website: "https://example.com" })
