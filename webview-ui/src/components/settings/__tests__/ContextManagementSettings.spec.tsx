...
describe("ContextManagementSettings", () => {
  ...
  it("renders diagnostic settings", () => {
    ...
    expect(
      screen.getByTestId("include-diagnostic-messages-checkbox"),
    ).toBeInTheDocument();

    // Check for slider
    expect(
      screen.getByTestId("max-diagnostic-messages-slider"),
    ).toBeInTheDocument();
  ...
  it("calls setCachedStateField when include diagnostic messages checkbox is toggled", async () => {
    ...
    const checkbox = screen
      .getByTestId("include-diagnostic-messages-checkbox")
      .querySelector("input")!;
  ...
  it("renders other context management settings", () => {
    ...
    expect(
      screen.getByTestId("workspace-files-limit-slider"),
    ).toBeInTheDocument();
    expect(
      screen.getByTestId("max-concurrent-file-reads-slider"),
    ).toBeInTheDocument();

    // Check for checkboxes
    expect(
      screen.getByTestId("show-rooignored-files-checkbox"),
    ).toBeInTheDocument();
    expect(
      screen.getByTestId("auto-condense-context-checkbox"),
    ).toBeInTheDocument();
  });
  ...
  it("renders max read file line controls", () => {
    ...
    const alwaysFullReadCheckbox = screen.getByTestId(
      "max-read-file-always-full-checkbox",
    );
  ...
  it("renders with autoCondenseContext enabled", () => {
    ...
    const autoCondenseCheckbox = screen.getByTestId(
      "auto-condense-context-checkbox",
    );
  ...
  describe("Auto Condense Context functionality", () => {
    ...
    it("shows threshold settings when auto condense is enabled", () => {
      ...
      expect(
        screen.getByTestId("condense-threshold-slider"),
      ).toBeInTheDocument();
  ...
  it("handles boundary values for sliders", () => {
    ...
    const workspaceFilesSlider = screen.getByTestId(
      "workspace-files-limit-slider",
    );
  ...
  describe("Conditional rendering", () => {
    it("does not render threshold settings when autoCondenseContext is false", () => {
      ...
      expect(
        screen.queryByTestId("condense-threshold-slider"),
  ...
  describe("Accessibility", () => {
    it("has proper labels and descriptions", () => {
      ...
      expect(
        screen.getByText("settings:contextManagement.openTabs.label"),
      ).toBeInTheDocument();
      expect(
        screen.getByText("settings:contextManagement.workspaceFiles.label"),
      ).toBeInTheDocument();
      expect(
        screen.getByText("settings:contextManagement.rooignore.label"),
      ).toBeInTheDocument();

      // Check that descriptions are present
      expect(
        screen.getByText("settings:contextManagement.openTabs.description"),
      ).toBeInTheDocument();
      expect(
        screen.getByText(
      ...
      expect(
        screen.getByText("settings:contextManagement.rooignore.description"),
      ).toBeInTheDocument();
    });
    ...
    it("has proper test ids for all interactive elements", () => {
      ...
      expect(
        screen.getByTestId("max-read-file-line-input"),
      ).toBeInTheDocument();
      expect(
        screen.getByTestId("max-read-file-always-full-checkbox"),
      ).toBeInTheDocument();
    });
  });
  ...
  describe("Integration with translation system", () => {
    it("uses translation keys for all text content", () => {
      ...
      expect(
        screen.getByText("settings:sections.contextManagement"),
      ).toBeInTheDocument();
      expect(
        screen.getByText("settings:contextManagement.description"),
      ).toBeInTheDocument();
      expect(
        screen.getByText("settings:contextManagement.openTabs.label"),
      ).toBeInTheDocument();
