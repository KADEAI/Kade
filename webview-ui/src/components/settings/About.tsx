...
export const About = ({
  ...
  useRegisterSetting({
    settingId: "about-export",
    section: "about",
    label: t("settings:footer.settings.export"),
  });
  useRegisterSetting({
    settingId: "about-import",
    section: "about",
    label: t("settings:footer.settings.import"),
  });
  useRegisterSetting({
    settingId: "about-reset",
    section: "about",
    label: t("settings:footer.settings.reset"),
  });
  ...
  return (
    <div className={cn("flex flex-col gap-2", className)} {...props}>
      <Section className="flex flex-col gap-6">
        {/* About Card */}
        <div
          className="rounded-[24px] border border-vscode-input-border/30 bg-vscode-editor-background/40 p-5 flex flex-col gap-6 shadow-xl"
          data-setting-id="about-telemetry"
        >
            ...
            <div className="text-[13px] leading-relaxed opacity-90">
              <Trans
                ...
                components={{
                  emailLink: (
                    <VSCodeLink
                      href="mailto:support@kadei.org"
                      className="text-vscode-textLink-foreground"
                    />
                  ),
                  websiteLink: (
                    <VSCodeLink
                      href="https://kadei.org"
                      className="text-vscode-textLink-foreground"
                    />
                  ),
                  githubLink: (
              ...
              <div className="flex flex-wrap items-center gap-2 mt-2 pt-4 border-t border-vscode-input-border/10">
                <Button
                  ...
                  onClick={() => {
                    setKiloCodeBloat([
                      ...kiloCodeBloat,
                      new Array<number>(20_000_000).fill(0),
                    ]);
                    console.debug(
