...
export const MODELS_BY_PROVIDER: Partial<
  Record<ProviderName, Record<string, ModelInfo>>
> = {
...
export const PROVIDERS = [
  ...
  { value: "gemini", label: "Google Gemini", website: "https://ai.google.dev" },
  {
    ...
    website:
      "https://cloud.google.com/vertex-ai/docs/generative-ai/code/code-assistance",
  },
  { value: "zed", label: "Zed", website: "https://zed.dev" },
  {
    value: "doubao",
    label: "Doubao",
  ...
  },
  {
    value: "bluesminds",
    label: "Bluesminds",
    website: "https://api.bluesminds.com",
  },
  {
    value: "inception",
    label: "Inception",
  ...
  {
    value: "virtual-quota-fallback",
    label: "Virtual Quota Fallback",
  ...
  { value: "synthetic", label: "Synthetic", website: "https://kilo.ai" },
  {
    ...
    website: "https://www.ovhcloud.com/en/lp/ai-endpoints",
  },
  {
    value: "sap-ai-core",
    label: "SAP AI Core",
    website: "https://www.sap.com/products/technology-platform/ai-core.html",
  },
  ...
  },
  {
    ...
    website: "https://io-intelligence.ai",
  },
  // kade_change start
