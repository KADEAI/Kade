...
export const BrowserSettings = ({
  ...
  useRegisterSetting({
    settingId: "browser-computer-use",
    section: "browser",
    label: t("settings:browser.computerUse.label", {
  ...
  useRegisterSetting({
    settingId: "browser-remote-url",
    section: "browser",
    label: t("settings:browser.remote.urlPlaceholder"),
  });
  useRegisterSetting({
    settingId: "browser-headless",
    section: "browser",
    label: t("settings:browser.headless.label"),
  }); // kade_change
      ...
      <Section className="flex flex-col gap-6">
        ...
        <div className="rounded-[24px] border border-vscode-input-border/30 bg-vscode-editor-background/40 p-5 flex flex-col gap-5 shadow-xl">
          ...
          <div className="flex flex-col gap-4">
            ...
            <div data-setting-id="browser-computer-use">
              <VSCodeCheckbox
                checked={computerUseToolEnabled}
                onChange={(e: any) =>
                  setCachedStateField(
                    "computerUseToolEnabled",
                    e.target.checked,
              ...
              >
                <span className="font-medium text-[13px]">
                  {t("settings:browser.computerUse.label", {
                    defaultValue: "Enable computer use",
                  })}
                </span>
              </VSCodeCheckbox>
              <div className="text-vscode-descriptionForeground text-[11px] mt-1 pl-7 opacity-80 leading-relaxed">
                {t("settings:browser.computerUse.description", {
                  defaultValue:
                    "When enabled, Kade can use desktop screenshots, mouse, keyboard, and scrolling tools outside the browser.",
                })}
              </div>
            </div>
            ...
            <div data-setting-id="browser-headless">
              <VSCodeCheckbox
                ...
                onChange={(e: any) =>
                  setCachedStateField(
                    "disableBrowserHeadless",
                    e.target.checked,
                  )
                }
              >
                <span className="font-medium text-[13px]">
                  {t("settings:browser.headless.label")}
                </span>
              </VSCodeCheckbox>
              <div className="text-vscode-descriptionForeground text-[11px] mt-1 pl-7 opacity-80 leading-relaxed">
              ...
              <div className="flex flex-col gap-5 pl-4 border-l-2 border-vscode-focusBorder/50 ml-1">
                <div data-setting-id="browser-viewport">
                  ...
                  <Select
                    ...
                    onValueChange={(value) =>
                      setCachedStateField("browserViewportSize", value)
                    }
                  >
                ...
                {remoteBrowserEnabled && (
                  <div
                    className="flex flex-col gap-3 pl-7"
                    data-setting-id="browser-remote-url"
                  >
                    <div className="flex items-center gap-2">
                      <VSCodeTextField
                        ...
                        placeholder={t(
                          "settings:browser.remote.urlPlaceholder",
                        )}
                        className="flex-1"
                      />
                      <Button
