...
export const SlashCommandsSettings: React.FC = () => {
  ...
  useRegisterSetting({
    settingId: "slash-commands-section",
  ...
  const builtInCommands =
    commands?.filter((cmd) => cmd.source === "built-in") || [];
  const globalCommands =
    commands?.filter((cmd) => cmd.source === "global") || [];
  const projectCommands =
    commands?.filter((cmd) => cmd.source === "project") || [];
    ...
    <div>
      <Section className="flex flex-col gap-6">
        ...
        <div
          ...
          data-setting-id="slash-commands-section-global"
        >
        ...
        {hasWorkspace && (
          <div
            className="rounded-[24px] border border-vscode-input-border/30 bg-vscode-editor-background/40 p-5 flex flex-col gap-5 shadow-xl"
            data-setting-id="slash-commands-section-workspace"
          >
            <div className="flex items-center gap-2 border-b border-vscode-input-border/50 pb-2">
        ...
        {builtInCommands.length > 0 && (
          <div
            className="rounded-[24px] border border-vscode-input-border/30 bg-vscode-editor-background/40 p-5 flex flex-col gap-5 shadow-xl"
            data-setting-id="slash-commands-section-builtin"
          >
            <div className="flex items-center gap-2 border-b border-vscode-input-border/50 pb-2">
      ...
      <AlertDialog open={deleteDialogOpen} onOpenChange={setDeleteDialogOpen}>
        <AlertDialogContent
          onEscapeKeyDown={handleDeleteCancel}
          ...
          <div className="space-y-6">
            ...
            <AlertDialogFooter className="flex flex-col gap-2">
              ...
              <AlertDialogCancel
                ...
                className="w-full h-9 rounded-xl bg-transparent hover:bg-white/5 text-vscode-descriptionForeground text-xs border-none transition-all"
              >
