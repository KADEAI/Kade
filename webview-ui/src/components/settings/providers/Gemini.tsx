...
export const Gemini = ({
  ...
  const [googleGeminiBaseUrlSelected, setGoogleGeminiBaseUrlSelected] =
    useState(!!apiConfiguration?.googleGeminiBaseUrl);
    ...
    <>
      ...
      >
        <label className="block font-medium mb-1">
          {t("settings:providers.geminiApiKey")}
        </label>
      </VSCodeTextField>
            ...
            <CollapsibleContent className="space-y-4 mt-2 pl-4 border-l border-vscode-editor-lineHighlightBorder">
              ...
              <div className="flex flex-col gap-1">
                ...
                <div className="text-[11px] text-vscode-descriptionForeground pl-6 leading-normal">
                  {t(
                    "settings:providers.geminiParameters.urlContext.description",
                  )}
                </div>
              </div>
              ...
              <div className="flex flex-col gap-1">
                ...
                >
                  {t(
                    "settings:providers.geminiParameters.groundingSearch.title",
                  )}
                </Checkbox>
                <div className="text-[11px] text-vscode-descriptionForeground pl-6 leading-normal">
                  {t(
                    "settings:providers.geminiParameters.groundingSearch.description",
                  )}
                </div>
              </div>
            </CollapsibleContent>
