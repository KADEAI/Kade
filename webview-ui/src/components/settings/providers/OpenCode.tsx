...
import { OrganizationAllowList, type ProviderSettings, opencodeDefaultModelId } from "@roo-code/types"
    ...
    return (
        <>
            ...
            {!apiConfiguration?.opencodeApiKey && (
                <VSCodeButtonLink href="https://opencode.ai/zen" style={{ width: "100%" }} appearance="primary">
