...
export const CliProxy = ({
  apiConfiguration,
  setApiConfigurationField,
}: CliProxyProps) => {
  const { t } = useTranslation();
  const [models, setModels] = useState<
    Record<string, { id: string; info: any }>
  >({});
  ...
  const selectedChannel = channels.find(
    (c) => c.value === apiConfiguration.cliProxyAuthId,
  );
    ...
    <div className="flex flex-col gap-3">
      <div className="flex flex-col gap-2">
        ...
        <SearchableSelect
          ...
          onValueChange={(value) =>
            setApiConfigurationField("cliProxyAuthId", value)
          }
          options={channels}
        ...
        <div className="flex flex-col gap-2">
          ...
          <StyledLoginButton
            ...
            onClick={() => {
              vscode.postMessage({
                type: "cliProxyLogin",
                provider: selectedChannel.value,
              });
            }}
          >
          ...
          <p className="text-xs text-vscode-descriptionForeground">
            Manage your accounts (Claude, Google, Codex, etc.) via the 9Router
            web dashboard.
          </p>
        </div>
      )}
      ...
      <div className="flex flex-col gap-2 mt-2 pt-2 border-t border-vscode-input-border/20">
        <span className="text-xs font-bold text-vscode-descriptionForeground uppercase">
          Advanced
        </span>
        <div className="flex flex-col gap-2">
          <label className="text-xs font-medium text-vscode-descriptionForeground">
          ...
          <VSCodeTextField
            ...
            onInput={(e: any) =>
              setApiConfigurationField("cliProxyPath", e.target.value)
            }
        ...
        <div className="flex flex-col gap-2">
          ...
          <VSCodeTextField
            ...
            onInput={(e: any) =>
              setApiConfigurationField("cliProxyApiKey" as any, e.target.value)
            }
