...
describe("SapAiCore Component", () => {
  ...
  describe("Initial Rendering", () => {
    it("should render all input fields with correct labels", () => {
      ...
      expect(
        screen.getByLabelText("settings:providers.sapAiCore.serviceKey"),
      ).toBeInTheDocument();
      expect(
        screen.getByLabelText("settings:providers.sapAiCore.resourceGroup"),
      ).toBeInTheDocument();
    });
  ...
  describe("Input Field Behavior", () => {
    it("should call setApiConfigurationField when input values change", async () => {
      ...
      await act(async () => {
        fireEvent.change(serviceKeyInput, {
  ...
  describe("Orchestration Mode", () => {
    it("should toggle orchestration mode when checkbox is clicked", async () => {
      ...
      const checkbox = screen.getByTestId(
        "checkbox-input-sap-ai-core-orchestration",
      );
      await act(async () => {
    ...
    it("should show warning message when orchestration is disabled", () => {
      ...
      expect(
        screen.getByText("settings:providers.sapAiCore.supportedProviders"),
      ).toBeInTheDocument();
      expect(
        screen.getByText(
          "settings:providers.sapAiCore.supportedProvidersDesc1",
        ),
      ).toBeInTheDocument();
    });
    ...
    it("should hide warning message when orchestration is enabled", () => {
      ...
      expect(
        screen.queryByText("settings:providers.sapAiCore.supportedProviders"),
  ...
  describe("Model Deployment Description", () => {
    it("should show model deployment description when orchestration is disabled and no model is selected", () => {
      ...
      expect(
        screen.getByText("settings:providers.sapAiCore.modelDeploymentDesc"),
      ).toBeInTheDocument();
    });
    ...
    it("should hide model deployment description when orchestration is enabled", () => {
      ...
      expect(
        screen.queryByText("settings:providers.sapAiCore.modelDeploymentDesc"),
      ).not.toBeInTheDocument();
    });
  ...
  describe("Model Selection", () => {
    it("should simulate receiving models from message handler", async () => {
      ...
      await waitFor(() => {
        expect(
          screen.getByText("settings:providers.sapAiCore.modelsCount (2)"),
        ).toBeInTheDocument();
      });
    });
    ...
    it("should disable models without any deployments when orchestration is disabled", async () => {
      ...
      const gpt4oOption = Array.from(options).find(
        (option) => option.getAttribute("value") === "gpt-4o",
      );
      expect(gpt4oOption).toHaveProperty("disabled", true);

      // Find the gpt-4o-mini option (should be enabled as it has a deployment)
      const gpt4oMiniOption = Array.from(options).find(
        (option) => option.getAttribute("value") === "gpt-4o-mini",
      );
    ...
    it("should enable all models when orchestration is enabled", async () => {
      ...
      const modelOptions = Array.from(options).filter(
  ...
  describe("Deployment Selection", () => {
    it("should not show deployment selector when orchestration is enabled", () => {
      ...
      expect(
        screen.queryByText("settings:providers.sapAiCore.deployment"),
      ).not.toBeInTheDocument();
    });
    ...
    it("should show deployment selector when orchestration is disabled and model is selected", async () => {
      ...
      expect(
        screen.getByText("settings:providers.sapAiCore.deployment"),
      ).toBeInTheDocument();
    });
    ...
    it("should show deployment count for selected model", async () => {
      ...
      await waitFor(() => {
        expect(
          screen.getByText("settings:providers.sapAiCore.deploymentsCount (1)"),
        ).toBeInTheDocument();
      });
    });
    ...
    it("should show correct placeholder text based on deployment availability", async () => {
      ...
      await waitFor(() => {
        expect(
          screen.getByText("settings:providers.sapAiCore.selectDeployment"),
        ).toBeInTheDocument();
      });
      ...
      await waitFor(() => {
        expect(
          screen.getByText("settings:providers.sapAiCore.noDeploymentFound"),
        ).toBeInTheDocument();
      });
    });
  });
  ...
  describe("Loading States", () => {
    it("should show loading state for models", () => {
      ...
      expect(
        screen.getByText("settings:providers.sapAiCore.loading"),
      ).toBeInTheDocument();
    });
  ...
  describe("Edge Cases and Error Handling", () => {
    it("should handle empty models response", async () => {
      ...
      await waitFor(() => {
        expect(
          screen.getByText("settings:providers.sapAiCore.modelsCount (0)"),
        ).toBeInTheDocument();
      });
    });
  ...
  describe("Component Integration", () => {
    ...
    it("should properly handle refetch triggers", async () => {
      ...
      const resourceGroupInput = screen.getByTestId(
