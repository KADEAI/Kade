...
describe("Gemini", () => {
  ...
  // kade_change start: Custom render function with required providers
  const renderGemini_kiloCode = (
    props: React.ComponentProps<typeof Gemini>,
  ) => {
  ...
  describe("URL Context Checkbox", () => {
    it("should render URL context checkbox unchecked by default", () => {
      ...
      const checkbox = urlContextCheckbox.querySelector(
        "input[type='checkbox']",
      ) as HTMLInputElement;
  ...
  describe("Grounding with Google Search Checkbox", () => {
    it("should render grounding search checkbox unchecked by default", () => {
      ...
      const checkbox = groundingCheckbox.querySelector(
        "input[type='checkbox']",
      ) as HTMLInputElement;
      expect(checkbox.checked).toBe(false);
    });
  ...
  // kade_change start: Tests changed from render() to renderGemini_kiloCode()
  describe("simplifySettings prop", () => {
    it("should hide URL context and grounding checkboxes when simplifySettings is true, but keep custom base URL", () => {
      ...
      expect(
        screen.getByTestId("checkbox-custom-base-url"),
      ).toBeInTheDocument();
      // Should not render URL context and grounding checkboxes
      expect(
        screen.queryByTestId("checkbox-url-context"),
      ).not.toBeInTheDocument();
      expect(
        screen.queryByTestId("checkbox-grounding-search"),
      ).not.toBeInTheDocument();
    });
    ...
    it("should show all checkboxes when simplifySettings is false", () => {
      ...
      expect(
        screen.getByTestId("checkbox-grounding-search"),
      ).toBeInTheDocument();
    });
