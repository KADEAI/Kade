...
describe("Bedrock Component", () => {
  ...
  it("should show text field when VPC endpoint checkbox is checked", () => {
    ...
    fireEvent.click(
      screen.getByTestId(
        "checkbox-input-settings:providers.awsbedrockvpc.usecustomvpcendpoint",
      ),
    );
  ...
  describe("Edge Cases", () => {
    it("should preserve endpoint URL when toggling checkbox multiple times", () => {
      ...
      expect(screen.getByTestId("vpc-endpoint-input")).toBeInTheDocument();
      expect(screen.getByTestId("vpc-endpoint-input")).toHaveValue(
  ...
  describe("UI Elements", () => {
    it("should display example URLs when VPC endpoint checkbox is checked", () => {
      ...
      expect(
        screen.getByText("settings:providers.awsBedrockVpc.examples"),
      ).toBeInTheDocument();
      expect(
        screen.getByText(
      ...
      expect(
        screen.getByText("• https://gateway.my-company.com/route/app/bedrock"),
      ).toBeInTheDocument();
    });
    ...
    it("should hide example URLs when VPC endpoint checkbox is unchecked", () => {
      ...
      expect(
        screen.queryByText("settings:providers.awsBedrockVpc.examples"),
  ...
  describe("Persistence", () => {
    it("should initialize with the correct state from apiConfiguration", () => {
      ...
      expect(
        screen.queryByTestId("vpc-endpoint-input"),
      ).not.toBeInTheDocument();
    });
    ...
    it("should update state when apiConfiguration changes", () => {
      ...
      expect(screen.getByTestId("vpc-endpoint-input")).toBeInTheDocument();
      expect(screen.getByTestId("vpc-endpoint-input")).toHaveValue(
        "https://updated-endpoint.aws.com",
      );
    });
