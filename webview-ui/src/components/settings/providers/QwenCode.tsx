...
export const QwenCode: React.FC<QwenCodeProps> = ({
  apiConfiguration,
  setApiConfigurationField,
}) => {
    ...
    <div className="flex flex-col gap-4">
      <div>
        ...
        <p className="text-xs mt-1 text-vscode-descriptionForeground">
          Path to your Qwen OAuth credentials file. Defaults to
          ~/.qwen/oauth_creds.json if left empty.
        </p>

        <div className="text-xs text-vscode-descriptionForeground mt-3">
          Qwen Code is an OAuth-based API that requires authentication through
          the official Qwen client. You&apos;ll need to set up OAuth credentials
          first.
        </div>
