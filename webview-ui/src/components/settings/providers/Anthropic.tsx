...
export const Anthropic = ({
  ...
  // kade_change start
  const [anthropicDeploymentSelected, setAnthropicDeploymentSelected] =
    useState(!!apiConfiguration?.anthropicDeploymentName);
  // kade_change end
    ...
    <>
      ...
      >
        <label className="block font-medium mb-1">
          {t("settings:providers.anthropicApiKey")}
        </label>
      </VSCodeTextField>
      ...
      <div className="mt-2">
        ...
        {anthropicDeploymentSelected && (
          <VSCodeTextField
            ...
            placeholder={t(
              "settings:providers.anthropicAzureDeploymentPlaceholder",
            )}
            className="w-full mt-1"
          />
        )}
