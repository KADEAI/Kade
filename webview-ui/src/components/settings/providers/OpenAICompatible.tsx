...
export const OpenAICompatible = ({
  ...
  const [openAiModels, setOpenAiModels] = useState<Record<
    string,
    ModelInfo
  > | null>(null);
  ...
  const onMessage = useCallback((event: MessageEvent) => {
    ...
    switch (message.type) {
      case "openAiModels": {
        ...
        setOpenAiModels(
          Object.fromEntries(
            updatedModels.map((item) => [item, openAiModelInfoSaneDefaults]),
          ),
        );
        break;
      }
      ...
      <div className="flex flex-col gap-3">
        ...
        <div>
          <VSCodeTextField
            ...
            style={{
              borderColor: (() => {
                const value =
                  apiConfiguration?.openAiCustomModelInfo?.contextWindow;
        ...
        <div>
          <div className="flex items-center gap-1">
            ...
            <StandardTooltip
              content={t(
                "settings:providers.customModel.promptCache.description",
              )}
            >
              <i
                className="codicon codicon-info text-vscode-descriptionForeground"
        ...
        <div>
          ...
          >
            <div className="flex items-center gap-1">
              ...
              <StandardTooltip
                content={t(
                  "settings:providers.customModel.pricing.input.description",
                )}
              >
                <i
                  className="codicon codicon-info text-vscode-descriptionForeground"
        ...
        <div>
          <VSCodeTextField
            ...
            style={{
              borderColor: (() => {
                const value =
                  apiConfiguration?.openAiCustomModelInfo?.outputPrice;
          ...
          >
            <div className="flex items-center gap-1">
              ...
              <StandardTooltip
                content={t(
                  "settings:providers.customModel.pricing.output.description",
                )}
              >
                <i
                  className="codicon codicon-info text-vscode-descriptionForeground"
        ...
        {apiConfiguration?.openAiCustomModelInfo?.supportsPromptCache && (
          <>
            <div>
              <VSCodeTextField
                value={
                  apiConfiguration?.openAiCustomModelInfo?.cacheReadsPrice?.toString() ??
                  "0"
                }
                type="text"
                style={{
                  borderColor: (() => {
                    const value =
                      apiConfiguration?.openAiCustomModelInfo?.cacheReadsPrice;
            ...
            <div>
              <VSCodeTextField
                ...
                style={{
                  borderColor: (() => {
                    const value =
                      apiConfiguration?.openAiCustomModelInfo?.cacheWritesPrice;
