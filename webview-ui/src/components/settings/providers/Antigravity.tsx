    ...
    <div className="flex flex-col gap-4">
      ...
      <div className="flex flex-col gap-3">
        <p className="text-xs text-vscode-descriptionForeground">
          Use your Google Account to access Gemini models via the Antigravity
          API. This is the same authentication method used by official Google
          integrations in tools like VS Code and JetBrains IDEs.
        </p>
      </div>
    </div>
  );
