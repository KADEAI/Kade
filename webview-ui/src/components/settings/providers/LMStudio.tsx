...
export const LMStudio = ({
  ...
  const modelNotAvailable = useMemo(() => {
    ...
    if (
      ...
      selectedModel in lmStudioModels
    ) {
    ...
    <>
      ...
      >
        <label className="block font-medium mb-1">
          {t("settings:providers.lmStudio.baseUrl")}
        </label>
      </VSCodeTextField>
      <VSCodeTextField
      ...
      >
        <label className="block font-medium mb-1">
          {t("settings:providers.lmStudio.modelId")}
        </label>
      </VSCodeTextField>
      {modelNotAvailable && (
        ...
        <>
          ...
          {Object.keys(lmStudioModels).length > 0 && (
            <>
              ...
              <VSCodeRadioGroup
                value={
                  (apiConfiguration?.lmStudioDraftModelId || "") in
                  lmStudioModels
                    ? apiConfiguration?.lmStudioDraftModelId
                    : ""
                }
