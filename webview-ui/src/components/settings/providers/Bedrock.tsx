...
export const Bedrock = ({
  ...
  const supports1MContextBeta =
    ...
    BEDROCK_1M_CONTEXT_MODEL_IDS.includes(apiConfiguration.apiModelId as any);
  ...
  const supportsGlobalInference =
    ...
    BEDROCK_GLOBAL_INFERENCE_MODEL_IDS.includes(
      apiConfiguration.apiModelId as any,
    );
  ...
  return (
    <>
        ...
        >
          ...
          <SelectContent>
            ...
            <SelectItem value="apikey">
              {t("settings:providers.awsApiKey")}
            </SelectItem>
          </SelectContent>
        </Select>
      </div>
      ...
      {apiConfiguration?.awsUseApiKey ? (
        ...
        >
          <label className="block font-medium mb-1">
            {t("settings:providers.awsProfileName")}
          </label>
        </VSCodeTextField>
      ) : (
        <>
          ...
          >
            <label className="block font-medium mb-1">
              {t("settings:providers.awsAccessKey")}
            </label>
          </VSCodeTextField>
          <VSCodeTextField
          ...
          >
            <label className="block font-medium mb-1">
              {t("settings:providers.awsSecretKey")}
            </label>
          </VSCodeTextField>
          <VSCodeTextField
      ...
      {awsEndpointSelected && (
        <>
          <VSCodeTextField
            ...
            placeholder={t(
              "settings:providers.awsBedrockVpc.vpcEndpointUrlPlaceholder",
            )}
