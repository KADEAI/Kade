    ...
    <>
      <div>
        <label className="block font-medium mb-1">
          {t("settings:providers.zaiEntrypoint")}
        </label>
        <VSCodeDropdown
          value={
            apiConfiguration.zaiApiLine ||
            zaiApiLineSchema.enum.international_coding
          }
      ...
      <div>
        ...
        >
          <label className="block font-medium mb-1">
            {t("settings:providers.zaiApiKey")}
          </label>
        </VSCodeTextField>
        ...
        {!apiConfiguration?.zaiApiKey && (
          <VSCodeButtonLink
            href={
              zaiApiLineConfigs[
                apiConfiguration.zaiApiLine ?? "international_coding"
              ].isChina
