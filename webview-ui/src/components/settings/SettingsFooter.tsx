...
export const SettingsFooter = ({ version, className, ...props }: SettingsFooterProps) => (
	<div className={cn("text-vscode-descriptionForeground p-5", className)} {...props}>
		<p style={{ wordWrap: "break-word", margin: 0, padding: 0 }}>
			...
			<VSCodeLink href="https://github.com/Kade-Org/kade" style={{ display: "inline" }}>
				github.com/Kade-Org/kade
			</VSCodeLink>{" "}
			or join{" "}
			<VSCodeLink href="https://www.reddit.com/r/Kade/" style={{ display: "inline" }}>
				reddit.com/r/Kade
			</VSCodeLink>
			.
		</p>
		<p style={{ wordWrap: "break-word", margin: 0, padding: 0 }}>
			...
			<VSCodeLink href="mail:hi@kade.ai" style={{ display: "inline" }}>
				hi@kade.ai
			</VSCodeLink>{" "}
		</p>
		<p className="italic">Kade v{version}</p>
