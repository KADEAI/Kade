...
describe("SlashCommandItemSimple", () => {
  ...
  it("renders command name with slash prefix", () => {
    render(
      <SlashCommandItemSimple command={mockCommand} onClick={mockOnClick} />,
    );
  ...
  it("does not render description when not provided", () => {
    ...
    render(
      <SlashCommandItemSimple
        command={commandWithoutDescription}
        onClick={mockOnClick}
      />,
    );

    expect(
      screen.queryByText("Test command description"),
  ...
  it("handles built-in commands correctly", () => {
    ...
    render(
      <SlashCommandItemSimple command={builtInCommand} onClick={mockOnClick} />,
    );
  ...
  it("handles project commands correctly", () => {
    ...
    render(
      <SlashCommandItemSimple command={projectCommand} onClick={mockOnClick} />,
    );
  ...
  it("truncates long command names", () => {
    ...
    render(
      <SlashCommandItemSimple
        command={longNameCommand}
        onClick={mockOnClick}
      />,
    );

    const nameElement = screen.getByText(
      "/this-is-a-very-long-command-name-that-should-be-truncated-in-the-ui",
    );
  ...
  it("truncates long descriptions", () => {
    ...
    render(
      <SlashCommandItemSimple
        command={longDescriptionCommand}
        onClick={mockOnClick}
      />,
    );
