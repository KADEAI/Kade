...
describe("CheckpointRestoreDialog", () => {
  ...
  describe("Basic Rendering", () => {
    it("renders edit dialog without checkpoint", () => {
      ...
      expect(
        screen.queryByText("Restore to Checkpoint"),
    ...
    it("renders edit dialog with checkpoint option", () => {
      render(
        <CheckpointRestoreDialog {...defaultProps} hasCheckpoint={true} />,
      );
  ...
  describe("User Interactions", () => {
    ...
    it("calls onConfirm with correct parameters when edit only is clicked", () => {
      ...
      render(
        <CheckpointRestoreDialog {...defaultProps} onConfirm={onConfirm} />,
      );
  ...
  describe("Accessibility", () => {
    it("has proper ARIA labels and roles", () => {
      ...
      expect(
        screen.getByRole("button", { name: "Edit Only" }),
      ).toBeInTheDocument();
      expect(
        screen.getByRole("button", { name: "Restore to Checkpoint" }),
      ).toBeInTheDocument();
      expect(
