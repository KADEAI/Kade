  ...
  useTranslation: () => ({
    t: (key: string, params?: any) => {
      const translations: Record<string, string> = {
        ...
        "indexingStatus.tooltip.indexed":
          "Codebase has been successfully indexed",
        "indexingStatus.tooltip.clickToSettings":
          "Click to open indexing settings",
      };
