...
describe("CodeIndexPopover", () => {
  ...
  it("should render the popover window content", () => {
    ...
    expect(
      screen.getByText("settings:codeIndex.description"),
    ).toBeInTheDocument();
  ...
  it("should enable the save button when a setting is changed", async () => {
    ...
    // Find the save button - it should be disabled initially
    const saveButton = screen.getByText("settings:codeIndex.saveSettings");
    expect(saveButton).toBeDisabled();

    // Change a setting (e.g., toggle the checkbox)
    ...
    // Clicking save should send the message
