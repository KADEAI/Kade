...
describe.skip("ShareButton", () => {
  ...
  test("opens popover when clicked", async () => {
    ...
    await waitFor(() => {
      expect(
        screen.getByText("chat:task.shareWithOrganization"),
      ).toBeInTheDocument();
    });
  });
  ...
  test("displays success message when shareTaskSuccess message received", async () => {
    ...
    await waitFor(() => {
      expect(
        screen.getByText("chat:task.shareSuccessOrganization"),
      ).toBeInTheDocument();
    });
  });
  ...
  test("displays different success messages based on visibility", async () => {
    ...
    await waitFor(() => {
      expect(
        screen.getByText("chat:task.shareSuccessPublic"),
      ).toBeInTheDocument();
    });
  });
  ...
  test("auto-hides success message after 5 seconds", async () => {
    ...
    expect(
      screen.queryByText("chat:task.shareSuccessOrganization"),
    ).not.toBeInTheDocument();
    expect(
      screen.queryByText("chat:task.shareWithOrganization"),
    ).not.toBeInTheDocument();
