...
describe("ErrorRow", () => {
  describe("basic rendering", () => {
    ...
    it("renders custom title when provided", () => {
      render(
        <ErrorRow type="error" title="Custom Title" message="Test message" />,
      );
    ...
    it("hides generic empty error rows that only have details", () => {
      const { container } = render(
        <ErrorRow
          type="error"
          message="Error"
          errorDetails="Actual tool failure details"
        />,
      );
  ...
  describe("login button", () => {
    ...
    it("keeps login errors visible even when the visible message is generic", () => {
      render(
        <ErrorRow
          type="error"
          message="Error"
          errorDetails="KiloCode token + baseUrl is required"
          showLoginButton={true}
          onLoginClick={() => {}}
        />,
      );
