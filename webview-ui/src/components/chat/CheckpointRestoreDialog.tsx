...
import { History as HistoryIcon, RotateCcw, Edit3, Trash2, Undo2, X, AlertTriangle, FilePlus } from "lucide-react"
				...
				<div className="flex flex-col max-h-[85vh]">
					...
					<div className="p-4 pb-2 text-center space-y-2.5">
						<div className={cn(
							...
							{isEdit ? <RotateCcw className="text-blue-400" size={18} /> : <Undo2 className="text-red-400" size={18} />}
						</div>
