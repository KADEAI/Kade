...
const createValidationSchema = (provider: EmbedderProvider, vectorStoreProvider: string, t: any) => {
...
export const CodeIndexPopover: React.FC<CodeIndexPopoverProps> = ({
	...
	useEffect(() => {
		...
		if (codebaseIndexConfig) {
			const settings = {
				...
				codebaseIndexIncludePaths: codebaseIndexConfig.codebaseIndexIncludePaths || [],
	...
	useEffect(() => {
		...
		const handleFolderSelection = (event: MessageEvent<any>) => {
			if (event.data.type === "vsCodeSetting" && event.data.setting === "selectedFolder") {
					...
					<div className="p-4">
						...
						<div className="mb-4">
							<div className="flex items-center gap-2">
								<VSCodeCheckbox
									...
									<span className="font-medium">{t("settings:codeIndex.enableLabel")} (Semantic Search)</span>
								</VSCodeCheckbox>
							...
							<p className="text-xs text-vscode-descriptionForeground mt-1 ml-6">
								Basic code search (Ask) is always available. Enable this for advanced semantic capabilities.
							</p>
						</div>
								...
								<div className="mt-4 space-y-4">
									...
									<div className="space-y-2">
										...
										<Select
											...
											<SelectContent>
												<SelectItem value="local-qdrant">Local Qdrant</SelectItem>
												<SelectItem value="qdrant">Qdrant (Remote/Docker)</SelectItem>
							...
							{isAdvancedSettingsOpen && (
								<div className="mt-4 space-y-4">
									...
									<div className="space-y-2">
										<div className="flex items-center gap-2">
											<label className="text-sm font-medium">
												{t("settings:codeIndex.includePathsLabel") || "Include Only Folders"}
											</label>
											<StandardTooltip
												content={
										...
										<div className="flex flex-wrap gap-2 mb-2">
											{(currentSettings.codebaseIndexIncludePaths || []).map((path) => (
												<div
													key={path}
													...
													<button
														onClick={() => {
															...
															updateSetting("codebaseIndexIncludePaths", newPaths)
														}}
						...
						<div className="flex items-center justify-between gap-2 pt-6">
							...
							<Button
								...
								className={cn(saveStatus === "saving" && "opacity-70 cursor-wait")}>
								{saveStatus === "saving"
