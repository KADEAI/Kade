...
import { stripSharedProtocolMarkdown } from "./markdownCleanup";
...
export const Markdown = memo(
  ({
    ...
    const cleanMarkdown = stripSharedProtocolMarkdown(markdown)
    ...
    return (
      <div
        ...
        style={{
          ...
          maxWidth: "var(--chat-markdown-max-width, none)",
              ...
              <VSCodeButton
                ...
                style={{
                  ...
                  background: hasCopied
                    ...
                    : "transparent",
                  transition:
                    "background 0.2s ease-in-out, transform 0.15s cubic-bezier(0.22, 1, 0.36, 1)",
                  color: hasCopied
                    ? "white"
