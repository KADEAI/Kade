...
const FilePathButton = styled.button`
    ...
    border-radius: 4px;
    cursor: pointer;
    font-family: var(--vscode-editor-font-family), "Apple Color Emoji", "Noto Color Emoji", "Segoe UI Emoji", sans-serif;
    font-size: 0.9em;
...
export const ToolFilePath: React.FC<ToolFilePathProps> = ({ filePath, startLine, endLine }) => {
