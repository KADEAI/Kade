...
export const ResearchWebTool: React.FC<ResearchWebToolProps> = ({
  tool,
  toolResult,
  isLastMessage,
  shouldAnimate,
  ...
  return (
    <div className={shouldAnimate ? "animate-tool-entry" : ""}>
      <ToolHeader
        toolName="research_web" // or web? keeping descriptive
        ...
        details={
          <span
            className="text-vscode-descriptionForeground opacity-50 truncate antialiased"
            title={query}
          >
            "{query}"
          </span>
