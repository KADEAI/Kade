...
export const RunSubAgentTool: React.FC<RunSubAgentToolProps> = ({ 
    ...
    const isPermissionRequest = !toolResult && isLastMessage && autoApprovalEnabled === true && alwaysAllowSubtasks === true;
                    ...
                    <ToolUseBlock>
                        <div
                            ...
                            <div
                                ...
                                <i className="codicon codicon-robot text-vscode-charts-purple" style={{ fontSize: '14px' }} />
                                <span style={{ 
                                    fontWeight: "600", 
                                    fontSize: "11px",
