...
export const TaskTimelineMessage = memo(
  ({ data, activeIndex, onClick }: TaskTimelineMessageProps) => {
        ...
        <Tooltip>
          <TooltipTrigger asChild>
            <div
              ...
              style={{
                height: `${(data.sizeData.height / MAX_HEIGHT_PX) * 100}%`,
              }}
              onClick={onClick}
            />
          </TooltipTrigger>
