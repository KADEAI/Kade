  ...
  return (
    <div className="border-t border-vscode-panel-border/50 bg-vscode-sideBar-background/30">
      <button
        ...
        className="w-full px-3 py-1 flex items-center justify-between hover:bg-vscode-list-hoverBackground transition-colors"
      >
                ...
                <div className="flex-1">
                  {editState.isEditing ? (
                    <input
                      ...
                      onChange={(e) =>
                        setEditState(item.pattern, true, e.target.value)
                      }
