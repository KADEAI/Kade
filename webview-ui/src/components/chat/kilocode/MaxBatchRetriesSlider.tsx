...
export const MaxBatchRetriesSlider: React.FC<MaxBatchRetriesSliderProps> = ({
  value,
  onChange,
}) => {
  ...
  const currentValue =
    value ?? CODEBASE_INDEX_DEFAULTS.DEFAULT_SCANNER_MAX_BATCH_RETRIES;
  ...
  return (
    <div className="space-y-2">
      <div className="flex items-center gap-2">
        ...
        <StandardTooltip
          content={t(
            "kilocode:settings.codeIndex.scannerMaxBatchRetriesDescription",
          )}
        >
      ...
      <div className="flex items-center gap-2">
        ...
        <VSCodeButton
          ...
          onClick={() =>
            onChange(CODEBASE_INDEX_DEFAULTS.DEFAULT_SCANNER_MAX_BATCH_RETRIES)
          }
        >
