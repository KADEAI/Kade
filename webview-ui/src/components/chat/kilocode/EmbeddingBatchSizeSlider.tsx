...
export const EmbeddingBatchSizeSlider: React.FC<
  EmbeddingBatchSizeSliderProps
> = ({ value, onChange }) => {
  const { t } = useAppTranslation();

  const currentValue =
    value ?? CODEBASE_INDEX_DEFAULTS.DEFAULT_EMBEDDING_BATCH_SIZE;
  ...
  return (
    <div className="space-y-2">
      <div className="flex items-center gap-2">
        ...
        <StandardTooltip
          content={t(
            "kilocode:settings.codeIndex.embeddingBatchSizeDescription",
          )}
        >
      ...
      <div className="flex items-center gap-2">
        ...
        <VSCodeButton
          ...
          onClick={() =>
            onChange(CODEBASE_INDEX_DEFAULTS.DEFAULT_EMBEDDING_BATCH_SIZE)
          }
        >
