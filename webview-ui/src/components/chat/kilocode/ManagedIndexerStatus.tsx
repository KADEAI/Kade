...
export const ManagedIndexerStatus: React.FC<ManagedIndexerStatusProps> = ({
  workspaceFolders,
}) => {
        ...
        return (
          ...
          >
            ...
            >
              ...
              <span
                className={cn(
                  "inline-flex items-center gap-1.5 text-xs flex-shrink-0",
                  {
                    "text-yellow-500": folder.isIndexing,
                    "text-green-500":
                      !folder.isIndexing && folder.hasManifest && !folder.error,
              ...
              <div className="px-3 pb-3 space-y-1 text-xs text-vscode-descriptionForeground border-t border-vscode-dropdown-border">
                ...
                {folder.gitBranch && (
                  <div className="flex justify-between pt-2">
                    <span>Branch:</span>
                    <code className="font-mono text-vscode-foreground">
                      {folder.gitBranch}
                    </code>
                  </div>
                )}
