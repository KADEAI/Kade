...
export const OrganizationIndexingTab: React.FC<
  OrganizationIndexingTabProps
> = ({ indexingStatus, onCancelIndexing }) => {
          ...
          <div className="text-xs text-vscode-descriptionForeground space-y-1">
            ...
            <div className="flex justify-between">
              ...
              <span className="font-medium">
                {indexingStatus.manifest.totalFiles.toLocaleString()}
              </span>
            </div>
            <div className="flex justify-between">
              <span>Total chunks:</span>
              <span className="font-medium">
                {indexingStatus.manifest.totalChunks.toLocaleString()}
              </span>
            </div>
            <div className="flex justify-between">
