...
} from "../settings/AutoApproveToggle";
...
export const AutoApproveDropdown = ({
  ...
  const { hasEnabledOptions, effectiveAutoApprovalEnabled } =
    useAutoApprovalState(toggles, autoApprovalEnabled);
  ...
  return (
    <Popover
      ...
      data-testid="auto-approve-dropdown-root"
    >
        ...
        <div className="flex flex-col w-full">
            ...
            <div className="flex flex-col gap-1">
              {settingsArray.map(({ key, labelKey, descriptionKey, icon }) => {
                ...
                return (
                  ...
                  >
                    <span
                      className={`codicon codicon-${icon} text-sm flex-shrink-0 w-4 h-4 flex items-center justify-center ${isEnabled ? "text-vscode-button-background" : "opacity-60"}`}
                    />
          ...
          <div className="flex flex-row items-center justify-between px-3 py-3 border-t border-vscode-dropdown-border/50 bg-white/5">
            ...
            >
              ...
              <span
                className={cn(
                  "text-[11px] font-bold uppercase tracking-wider text-vscode-foreground",
                )}
              >
