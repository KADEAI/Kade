...
interface LucideIconButtonProps
...
export const LucideIconButton = forwardRef<
  HTMLButtonElement,
  LucideIconButtonProps
>(
  (
    {
      icon,
      ...
      <StandardTooltip content={tooltip ? title : undefined}>
        <Button
          ...
          className={cn(
            ...
            !disabled &&
              "cursor-pointer hover:opacity-100 hover:bg-[rgba(255,255,255,0.03)]",
            disabled &&
