...
export function validateApiConfiguration(
  ...
  const keysAndIdsPresentErrorMessage =
    validateModelsAndKeysProvided(apiConfiguration);

  if (keysAndIdsPresentErrorMessage) {
    return keysAndIdsPresentErrorMessage;
  }

  const organizationAllowListError =
    validateProviderAgainstOrganizationSettings(
      apiConfiguration,
  ...
  switch (apiConfiguration.apiProvider) {
    ...
    case "sap-ai-core":
      ...
      if (
        ...
        !apiConfiguration.sapAiCoreDeploymentId
      ) {
...
export function getModelValidationError(
  ...
  const orgError = validateProviderAgainstOrganizationSettings(
    configWithModelId,
    organizationAllowList,
  );
...
export function validateApiConfigurationExcludingModelErrors(
  ...
  if (
    ...
    organizationAllowListError.code === "PROVIDER_NOT_ALLOWED"
  ) {
    return organizationAllowListError.message;
  }
