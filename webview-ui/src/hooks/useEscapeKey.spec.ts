...
describe("useEscapeKey", () => {
  ...
  it("should prevent default when preventDefault option is true", () => {
    renderHook(() =>
      useEscapeKey(true, mockOnEscape, { preventDefault: true }),
    );
  ...
  it("should not prevent default when preventDefault option is false", () => {
    renderHook(() =>
      useEscapeKey(true, mockOnEscape, { preventDefault: false }),
    );
  ...
  it("should stop propagation when stopPropagation option is true", () => {
    renderHook(() =>
      useEscapeKey(true, mockOnEscape, { stopPropagation: true }),
    );
  ...
  it("should not stop propagation when stopPropagation option is false", () => {
    renderHook(() =>
      useEscapeKey(true, mockOnEscape, { stopPropagation: false }),
    );
  ...
  it("should always add event listener regardless of isOpen state", () => {
    ...
    const { rerender } = renderHook(
      ({ isOpen }) => useEscapeKey(isOpen, mockOnEscape),
      {
  ...
  it("should update callback when dependencies change", () => {
    const { rerender } = renderHook(
      ({ isOpen, onEscape }) => useEscapeKey(isOpen, onEscape),
      {
