...
const defaultTheme: ToolTheme = {
  ...
  toolAccents: {
    ...
    grep: "var(--vscode-descriptionForeground)",
    web: "#3794ff",
    fetch: "#b180d7",
    glob: "var(--vscode-descriptionForeground)",
    list: "var(--vscode-editor-foreground)",
...
const glassTheme: ToolTheme = {
  ...
  toolAccents: {
    read: "#a6e22e",
    grep: "rgba(255, 255, 255, 0.6)",
    web: "#66d9ef",
    fetch: "#ae81ff",
    glob: "rgba(255, 255, 255, 0.6)",
    list: "#e6db74",
    mkdir: "#e6db74",
    mcp: "#4ec9b0",
    browser: "#66d9ef",
...
export const ToolThemeProvider: React.FC<{ children: React.ReactNode }> = ({
  children,
}) => {
