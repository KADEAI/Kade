...
const TestComponent = () => {
  ...
  return (
    <div>
      ...
      <div data-testid="show-rooignored-files">
        {JSON.stringify(showRooIgnoredFiles)}
      </div>
      <div data-testid="auto-approval-enabled">
        {JSON.stringify(autoApprovalEnabled)}
      </div>
      <div data-testid="always-allow-read-only">
        {JSON.stringify(alwaysAllowReadOnly)}
      </div>
      <div data-testid="always-allow-write">
        {JSON.stringify(alwaysAllowWrite)}
      </div>
      <button
...
const ApiConfigTestComponent = () => {
  ...
  return (
    <div>
      <div data-testid="api-configuration">
      ...
      <button
        ...
        onClick={() => setApiConfiguration({ modelTemperature: 0.7 })}
      >
        Partial Update
      </button>
    </div>
...
describe("ExtensionStateContext", () => {
  ...
  it("initializes with showRooIgnoredFiles set to true", () => {
    ...
    expect(
      JSON.parse(screen.getByTestId("show-rooignored-files").textContent!),
    ).toBe(true);
  });
  ...
  it("initializes with autoApprovalEnabled set to true", () => {
    ...
    expect(
      JSON.parse(screen.getByTestId("auto-approval-enabled").textContent!),
    ).toBe(true);
  });
  ...
  it("initializes with alwaysAllowReadOnly set to true", () => {
    ...
    expect(
      JSON.parse(screen.getByTestId("always-allow-read-only").textContent!),
    ).toBe(true);
  });
  ...
  it("initializes with alwaysAllowWrite set to true", () => {
    ...
    expect(
      JSON.parse(screen.getByTestId("always-allow-write").textContent!),
    ).toBe(true);
  });
