...
const kilocodeExperimentIds = ["morphFastApply", "speechToText", "enableSubAgents", "yoloMode"] as const // kilocode_change
...
export const experimentsSchema = z.object({
	...
	enableSubAgents: z.boolean().optional(), // kilocode_change
