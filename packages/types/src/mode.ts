...
export const DEFAULT_MODES: readonly ModeConfig[] = [
	{
		...
		whenToUse:
			"Use this mode for high-level technical planning. Create master plans that a Junior Engineer could execute without questions.",
	...
	},
	{
		...
		whenToUse:
			"Use this mode to SHIP CODE. High speed, high precision, zero friction.",
		description: "Write, modify, and refactor code",
		groups: ["read", "edit", "browser", "command", "mcp"],
		customInstructions:
			"1. Execute tasks with precision and efficiency. Focus on high-quality implementation.\n\n2. Provide brief, high-level context for your actions, explaining the 'why' behind architectural decisions or complex changes.\n\n3. Minimize conversational filler. You are here to ship code, not to chat. \n\n4. If a task is complex, outline your technical approach briefly before execution.",
	},

	{
		...
		whenToUse:
			"Use this mode to get FACTS. Instant answers, no fluff.",
	...
	},
	{
		...
		whenToUse:
			"Use this mode to KILL BUGS. Systematic, ruthless debugging.",
	...
	/*
	{
		...
		whenToUse:
			"Use this mode for COMPLEX MANEUVERS. Orchestrate multiple agents to solve big problems.",
