...
public interface TestInterfaceDefinition<T extends Comparable<T>> {
    ...
    void testInterfaceMethod(String message, T data); // kade_change: whitespace
    
    // Default method in interface - 4+ lines
    default String testInterfaceDefaultMethod(String input, T data) { // kade_change: whitespace
...
public class TestClassDefinition<T extends Comparable<T>>
    ...
    @Override
    public void testInterfaceMethod(String message, T data) { // kade_change: whitespace
