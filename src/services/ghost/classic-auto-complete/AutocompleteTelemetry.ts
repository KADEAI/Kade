...
export class AutocompleteTelemetry {
	...
	private captureEvent(event: TelemetryEventName, properties?: Record<string, unknown>): void {
		// PERFORMANCE OPTIMIZATION: Disable autocomplete telemetry to reduce overhead
		// Autocomplete telemetry fires on every keystroke and can impact typing responsiveness
