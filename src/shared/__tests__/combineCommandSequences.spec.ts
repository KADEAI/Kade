...
describe("combineCommandSequences", () => {
	describe("command sequences", () => {
		...
		it("should avoid duplicating cumulative command_output payloads", () => {
			const messages: ClineMessage[] = [
				{ type: "ask", ask: "command", text: "run", ts: 1 },
				{ type: "ask", ask: "command_output", text: "line1", ts: 2 },
				{ type: "ask", ask: "command_output", text: "line1\nline2", ts: 3 },
				{ type: "ask", ask: "command_output", text: "line1\nline2", ts: 4 },
			]
