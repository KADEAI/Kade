...
export async function getOllamaModels(
	...
	try {
		...
		if (error.code === "ECONNREFUSED") {
			// Only log as info to avoid console noise during background refreshes
			console.info(`[Ollama] Service not reachable at ${baseUrl} (expected if Ollama is not running)`)
		} else {
			console.error(
