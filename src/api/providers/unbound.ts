...
import { unboundDefaultModelId, unboundDefaultModelInfo, TOOL_PROTOCOL } from "@roo-code/types"
...
const DEFAULT_HEADERS = {
	"X-Unbound-Metadata": JSON.stringify({ labels: [{ key: "app", value: "claudix" }] }),
}
...
export class UnboundHandler extends RouterProvider implements SingleCompletionHandler {
	...
	public override async fetchModel() {
		this.models = await getModels({ provider: "unbound", apiKey: this.client.apiKey, baseUrl: this.client.baseURL } as const as any)
