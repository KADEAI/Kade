...
import { type MinimaxModelId, minimaxDefaultModelId, minimaxModels, TOOL_PROTOCOL } from "@roo-code/types"
				...
				case "content_block_start":
					switch (chunk.content_block.type) {
						...
						case "text":
							...
							// Only yield non-empty text from content_block_start
							// MiniMax (like Anthropic) sends empty text in content_block_start,
							// with actual content coming via text_delta chunks.
							// Yielding empty text triggers finalizeReasoning() in AgentLoop,
							// which prematurely closes the reasoning block.
