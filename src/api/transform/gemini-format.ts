...
export function convertAnthropicContentToGemini(
	...
	return {
		functionCall: {
			...
			// Claude via Antigravity REQUIRES a tool_use_id. 
			// We map the Anthropic 'id' to the internal 'id' field the proxy expects.
			id: (block as any).id || `call_${Math.random().toString(36).slice(2, 11)}`,
		},
	...
	return {
		functionResponse: { 
			...
			// Pass through the tool_use_id to match the call
