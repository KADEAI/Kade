// kade_change start - use SheetJS to extract text from XLSX files with improved cell handling
...
// kade_change end - use SheetJS to extract text from XLSX files with improved cell handling
