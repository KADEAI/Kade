...
export class AgentRegistry {
	 ...
	 */
	public setPendingSession(prompt: string, options?: CreateSessionOptions & { gitUrl?: string; teamId?: string; teamRole?: "leader" | "worker" | "validator" }): PendingSession {
	...
	public createSession(
		...
		prompt: string,
		startTime?: number,
		options?: CreateSessionOptions & { labelOverride?: string; gitUrl?: string; teamId?: string; teamRole?: "leader" | "worker" | "validator"; initialStatus?: AgentStatus },
	): AgentSession {
