...
describe("toolResultFormatting", () => {
	...
	describe("getCurrentToolProtocol", () => {
		it("should return configured protocol", () => {
			...
			expect(getCurrentToolProtocol()).toBe(TOOL_PROTOCOL.MARKDOWN)
		})
	...
	describe("isNativeProtocol", () => {
		it("should return true for native protocol", () => {
			expect(isNativeProtocol(TOOL_PROTOCOL.MARKDOWN)).toBe(true)
		})

		it("should return false for XML protocol", () => {
			expect(isNativeProtocol(TOOL_PROTOCOL.MARKDOWN)).toBe(false)
		})
	})
	...
	describe("formatToolInvocation", () => {
		...
		it("should handle empty parameters", () => {
			const result = formatToolInvocation("list_files", {}, TOOL_PROTOCOL.MARKDOWN)
