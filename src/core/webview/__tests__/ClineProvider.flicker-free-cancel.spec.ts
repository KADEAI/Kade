...
describe("ClineProvider flicker-free cancel", () => {
	...
	it("should not rehydrate a task after user cancellation", async () => {
		;(provider as any).clineStack = [mockTask1]
		;(provider as any).runningTasks = new Map([[mockTask1.taskId, mockTask1]])
		...
		expect(mockTask1.cancelCurrentRequest).toHaveBeenCalled()
