...
Description: This will let you create a new session or sub-task in the chosen mode using your provided message.
...
Description: This will let you create a new session or sub-task in the chosen mode using your provided message and initial todo list.
