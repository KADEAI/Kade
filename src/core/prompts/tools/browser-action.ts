...
Interact with a Puppeteer browser. Actions: launch (must be first), click, type, scroll_down, scroll_up, close (must be last).
<browser_action><action>...</action><url>...</url><coordinate>x,y@widthxheight</coordinate><text>...</text></browser_action>`
    }
    return `## browser_action
